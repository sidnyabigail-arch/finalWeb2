        ...
        {selectedProduct && (
          <div style={{ animation: 'fadeIn 0.3s ease-out' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #eee', paddingTop: '20px' }}>
              ...
              <button onClick={handleAddToCart} style={{ backgroundColor: 'var(--primary-pink)', color: 'white', padding: '12px 25px', borderRadius: '8px', border: 'none', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px' }}>
                Agregar al Carrito 🛒
              </button>
            </div>
          </div>
